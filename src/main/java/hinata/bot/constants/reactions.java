...
public enum reactions {
    HUG     (new String[] {"https://i.imgur.com/xELnNfC.gif",
    ...
    KISS    (new String[] {"https://i.imgur.com/04UFajc.gif",
    ...
    SLAP    (new String[] {"https://i.imgur.com/o5SrT0V.gif",
    ...
    BLUSH   (new String[] {"https://i.imgur.com/hJWIeMv.gif",
    ...
    GROPE   (new String[] {"https://i.imgur.com/lMNVEeS.gif",
    ...
    CRY     (new String[] {"https://i.imgur.com/gD8wSJt.gif",
    ...
    PAT     (new String[] {"https://i.imgur.com/o0RfGwO.gif",
